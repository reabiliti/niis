...
class ProposalsController < ApplicationController
  ...
  def proposal_params
    params.require(:proposal).permit(:number, :date_from, :cert_system, :applic_name,
                                     ...
                                     :applic_code_okpo, :applic_chief_position, :applic_chief_name,
                                     :applic_name_product, :applic_from_issue, :manuf_name, :manuf_address,
                                     :manuf_doc, :manuf_code_okato, :manuf_type_own, :manuf_code_okonh,
                                     :manuf_code_okved, :manuf_code_okpo, :manuf_regulations,
                                     :manuf_list_doc, :manuf_add_info, :manuf_chief_position,
                                     :manuf_chief_name, :manuf_chief_accountant, :applic_postcode,
                                     :applic_inn, :applic_kpp, :applic_code_okp, :applic_code_tn_ved,
